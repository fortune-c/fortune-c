  ...
  <tr>
    <td valign="top" width="50%">
      <pre>
                  ...
                  :c***c*==:```-**=:```:-=+*ssc==-:`.
                   -ssssssc*c*+==+++++++***c#%##scs##c*=-:``..
               `-+s#%#####sc**+++**+*ccccccc#%##sccs###%%#scssc*=:.
          .:=cs%%%%%%%%#s#sc****ccccccssssss#%##sssssss#%%sss#####sc+-.
      .-+s#%%%%%%%%%%%%%#*c###scc*++c###sc+=#%##ssssssss##ss##sss##ssss+
    -c#%%%%%%%%%%%%%%%%%s*=+==-:--=-=+-::`-s%%##sssssssssss#ss#####scsss
   =@%%%%%%%%%%%%%%%%%#sc*+**-:``::-=-:``:s@%%##%%%%%%%%%##s#######scsss
  -#%%%#%%%%%%%%%%%%%#ssscccc*+=:::-=+*+-+%%%##%%%%%%%%######%%%%%#sss#s
  c%%%%%%%%%%%%%%%%%##ssscccccss*+===++++s%%%%%%%%%%%%########%%%%ss####
  `%%%%%%%%%%%%%%%###sccccc*cccccsc+::::+#%%%#%%%%%%%###ss###%%%%######s
...
fortune@github:~$
  ...
  Stack:             C · C++ · Rust
  Focus:             Low-level
  Learning:          Computer Graphic · GPU Programming
  Currently:         BSc Software Engineering @ Miva
  Reading:           Computer Graphics: Principles and Practice
...
![Profile Views](https://komarev.com/ghpvc/?username=fortune-c&color=blueviolet&style=flat-square)
