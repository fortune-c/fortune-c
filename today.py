...
USER_NAME = os.environ['USER_NAME'] # e.g. 'fortune-c'
...
if __name__ == '__main__':
    ...
    # e.g {'id': '<graphql-user-id>'} and 2019-11-03T21:15:07Z for a given username
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 4, 23))
    ...
    # include archived repository stats when repository archive data exists
